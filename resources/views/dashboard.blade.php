...
<a href="{{ route('notification.markasread') }}" class="float-right text-light">Mark all as read</a>
</div>
</li>
...
<div>
    <a href="{{ route('posts.show',$notification->data['post_id']) }}">{{$notification->data['title'] }}
</div>
<small class="text-warning">{{$notification->data['created_at'] }}</small>
</div>
</div>
</li>
@endforeach
